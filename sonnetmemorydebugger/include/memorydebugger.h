...
extern void s_debug_memory_info_print(); // Will print (to stderr) a list of debugging information on memory management, such as if something was freed.


// Replace the memory management functions with the debug versions
